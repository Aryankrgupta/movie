...
const Home = () => {
    ...
    useEffect(() => {
        fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=f1c02c911183ebf7cd75dfc324da8315&language=en-US&page=1%27%20')
        .then(res => res.json())
  ...
  return (
    ...
    <Carousel api = {movie} trailer ={trailer} mTrailer = {mTrailer} moiveId = {moiveId}/>
